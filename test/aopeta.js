...
contract("AOPeta", function(accounts) {
	...
	contract("Network Ion Function Tests", function() {
		...
		it("transferBetweenPublicKeys() - should be able to transfer ions between public keys in a Name", async function() {
			...
			try {
				await aopeta.transferBetweenPublicKeys(someAddress, account1, account3, transferAmount, { from: account1 });
				canTransfer = true;
			} catch (e) {
				canTransfer = false;
			}
			...
			try {
				await aopeta.transferBetweenPublicKeys(nameId1, account1, account3, transferAmount, { from: account2 });
				canTransfer = true;
			} catch (e) {
				canTransfer = false;
			}
			...
			try {
				await aopeta.transferBetweenPublicKeys(nameId1, account2, account3, transferAmount, { from: account1 });
				canTransfer = true;
			} catch (e) {
				canTransfer = false;
			}
			...
			try {
				await aopeta.transferBetweenPublicKeys(nameId1, account1, account2, transferAmount, { from: account1 });
				canTransfer = true;
			} catch (e) {
				canTransfer = false;
			}
			...
			var account1Balance = await aopeta.balanceOf(account1);

			try {
				await aopeta.transferBetweenPublicKeys(nameId1, account1, account3, account1Balance.plus(1).toNumber(), { from: account1 });
				canTransfer = true;
			} catch (e) {
				canTransfer = false;
			}
			...
			try {
				await aopeta.transferBetweenPublicKeys(nameId1, account1, account3, transferAmount, { from: account1 });
				canTransfer = true;
			} catch (e) {
				canTransfer = false;
			}
			...
			var account1BalanceBefore = await aopeta.balanceOf(account1);
			var account3BalanceBefore = await aopeta.balanceOf(account3);
			...
			var account1BalanceAfter = await aopeta.balanceOf(account1);
			var account3BalanceAfter = await aopeta.balanceOf(account3);
			assert.equal(
				account1BalanceAfter.toNumber(),
